...
class save_img():
    def __init__(self,istrain,pretrain,slice_scope,max_epoch):
        ...
        self.public = r"/home/cyf/b1000-b0/E-GAN"
        self.cwd = os.getcwd() 
        ...
        if self.pretrain:
            ...
            self.train_img_dir = os.path.join(self.cwd,self.results+"/web/pretrain_images")
            self.train_nii_dir = os.path.join(self.cwd,self.results+"/web/pretrain_nii")
        else:
            self.results = "results"
            self.train_img_dir = os.path.join(self.cwd,self.results+"/web/images")
            self.train_nii_dir = os.path.join(self.cwd,self.results+"/web/nii")
        self.test_img_dir = os.path.join(self.cwd,self.results+"/web/test_images")
        self.test_nii_dir = os.path.join(self.cwd,self.results+"/web/test_nii")
        # self.path = os.path.join(self.public,"monkey_brain")
        self.log_name = os.path.join(self.cwd,self.results,"loss_log.txt")
        self.test_log_name = os.path.join(self.cwd,self.results,"test_loss_log.txt")
        self.train_quantitative_log_name = os.path.join(self.cwd,self.results,"train_quantitative_log.txt")
        ...
        if not os.path.exists(os.path.join(self.cwd,self.results)):
            os.mkdir(os.path.join(self.cwd,self.results))
        if not os.path.exists(os.path.join(self.cwd,self.results,"web")):
            os.mkdir(os.path.join(self.cwd,self.results,"web"))
