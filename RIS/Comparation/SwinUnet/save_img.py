...
class save_img():
    def __init__(self,istrain,pretrain,slice_scope,max_epoch,cfg):
        ...
        if self.istrain:
            mask_paths = os.path.join(self.public, "monkey_brain", cfg.train_mask)
            # mask_paths = os.path.join(self.public, "monkey_brain", "mask")
            smask_path = os.listdir(mask_paths)
            smask_path.sort()
        else:
            if self.pretrain:
                mask_paths = os.path.join(self.public,"monkey_brain",cfg.val_mask)
                smask_path = os.listdir(mask_paths)
                smask_path.sort()
            else:
                mask_paths = os.path.join(self.public,"monkey_brain",cfg.test_mask)
                smask_path = os.listdir(mask_paths)
                smask_path.sort()
        self.mask_list = []
