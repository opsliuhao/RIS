...
if __name__ == '__main__':
    ...
    model = pGAN(istrain, ispretrain, continue_train, read_dataset.get_slice_scope())
    ...
    for epoch in range(epoch_count,n_epochs_decay + n_epochs + 1):
        ...
        model.save(save_suffix, read_dataset.get_slice_scope())

        print('saving the model at the end of epoch %d,iters %d'%(epoch,total_iters))
        model.save('latest',read_dataset.get_slice_scope())
        model.save(epoch,read_dataset.get_slice_scope())
