...
class save_img():
    def __init__(self,istrain,pretrain,slice_scope,max_epoch):
        ...
        self.save_nii = os.getcwd()
        self.public = "/home/cyf/b1000-b0"
        self.istrain = istrain
        self.pretrain = pretrain
        if self.istrain:
            mask_paths = os.path.join(self.public, "monkey_brain", "train_mask")
            # mask_paths = os.path.join(self.public, "monkey_brain", "mask")
        ...
        if self.pretrain:
            ...
            self.train_img_dir = os.path.join(self.save_nii,"monkey_brain/"+self.results+"/web/pretrain_images")
            self.train_nii_dir = os.path.join(self.save_nii,"monkey_brain/"+self.results+"/web/pretrain_nii")
        else:
            self.results = "results"
            self.train_img_dir = os.path.join(self.save_nii,"monkey_brain/"+self.results+"/web/images")
            self.train_nii_dir = os.path.join(self.save_nii,"monkey_brain/"+self.results+"/web/nii")
        self.test_img_dir = os.path.join(self.save_nii,"monkey_brain/"+self.results+"/web/test_images")
        self.test_nii_dir = os.path.join(self.save_nii,"monkey_brain/"+self.results+"/web/test_nii")
        self.path = os.path.join(self.save_nii,"monkey_brain")
