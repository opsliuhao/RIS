...
def define_G(input_nc, output_nc, ngf, which_model_netG,vit_name,img_size, norm='batch', use_dropout=False, init_type='normal', gpu_ids=[],pre_trained_trans=True,pre_trained_resnet=0):
    netG = None
    ...
    def get_target_tensor(self, input, target_is_real):
        ...
        if target_is_real:
            ...
            if create_label:
                ...
                self.real_label_var = Variable(real_tensor, requires_grad=False).to('cuda:0')
            ...
            if create_label:
                ...
                self.fake_label_var = Variable(fake_tensor, requires_grad=False).to('cuda:0')
