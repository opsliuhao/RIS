...
class save_img():
    def __init__(self,istrain,pretrain,slice_scope,max_epoch):
        ...
        if self.pretrain:
            ...
            self.train_img_dir = os.path.join(self.cwd,"monkey_brain/"+self.results+"/web/pretrain_images")
            self.train_nii_dir = os.path.join(self.cwd,"monkey_brain/"+self.results+"/web/pretrain_nii")
        else:
            self.results = "results"
            self.train_img_dir = os.path.join(self.cwd,"monkey_brain/"+self.results+"/web/images")
            self.train_nii_dir = os.path.join(self.cwd,"monkey_brain/"+self.results+"/web/nii")
        self.test_img_dir = os.path.join(self.cwd,"monkey_brain/"+self.results+"/web/test_images")
        self.test_nii_dir = os.path.join(self.cwd,"monkey_brain/"+self.results+"/web/test_nii")
        self.path = os.path.join(self.cwd,"monkey_brain")
