...
class save_img():
    def __init__(self,istrain,pretrain,slice_scope,max_epoch):
        ...
        if self.istrain:
            mask_paths = os.path.join(self.public, "monkey_brain", "AMU_train_mask")
            # mask_paths = os.path.join(self.public, "monkey_brain", "mask")
            smask_path = os.listdir(mask_paths)
            smask_path.sort()
        else:
            if self.pretrain:
                mask_paths = os.path.join(self.public,"monkey_brain","AMU_val_mask")
                smask_path = os.listdir(mask_paths)
                smask_path.sort()
            else:
                mask_paths = os.path.join(self.public,"monkey_brain","AMU_test_mask")
                smask_path = os.listdir(mask_paths)
                smask_path.sort()
        self.mask_list = []
