    ...
    def __init__(self,istrain,ispretrain):
        ...
        if self.istrain:
            if self.ispretrain:
                ...
                self.T1_paths = os.path.join(self.path, "AMU_train_T1")
                self.T2_paths = os.path.join(self.path, "AMU_train_b0")
                # self.T1_paths = os.path.join(self.path, "test_t1")
                # self.T2_paths = os.path.join(self.path, "test_b0")
        else:
            if self.ispretrain:
                self.T1_paths = os.path.join(self.path, "AMU_val_T1")
                self.T2_paths = os.path.join(self.path, "AMU_val_b0")
            else:
                self.T1_paths = os.path.join(self.path, "b1000_test_data")
