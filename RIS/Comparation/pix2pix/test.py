...
if __name__ == '__main__':
    ...
    for i,data in enumerate(dataset):
        ...
        save_img.save_as_nii(model.get_current_visuals(),image_path,80,batchsize,False,read_dataset.get_T1_slices(),read_dataset.get_T2_slices(),read_dataset.T1_dict,read_dataset.B0_dict,read_dataset.get_affine_list(),read_dataset.get_size())
