...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_count,n_epochs_decay + n_epochs + 1):
        ...
        for i,data in enumerate(dataset):
            ...
            train_save_img.save_as_nii(model.get_current_visuals(),image_path,epoch,batchsize,True,read_dataset.get_T1_slices(),read_dataset.get_T2_slices(),read_dataset.T1_dict,read_dataset.B0_dict,read_dataset.get_affine_list(),read_dataset.get_size(),False)
        ...
        for i, test_data in enumerate(val_dataset):
            ...
            val_save_img.save_as_nii(model.get_current_visuals(), test_image_path, epoch, batchsize, False,
                             ...
                             real_val_dataset.B0_dict, real_val_dataset.get_affine_list(), real_val_dataset.get_size(),True)
    plt.ioff()
